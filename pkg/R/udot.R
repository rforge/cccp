...
setMethod("udot", signature = c("PSDV", "PSDV"), function(u, v){
    .sdot_p(drop(u@u), drop(v@u), u@dims)
})
setMethod("udot", signature = c("PSDV", "missing"), function(u, v){
    .sdot_p(drop(u@u), drop(u@u), u@dims)
})
